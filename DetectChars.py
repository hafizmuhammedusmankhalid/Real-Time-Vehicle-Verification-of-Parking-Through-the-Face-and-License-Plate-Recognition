...
def loadKNNDataAndTrainKNN():
    ...
    try:
        npaClassifications = np.loadtxt(r"C:\Users\hafiz\Anaconda\Final_Year_Project_Implementation\License_Plate_Recognition_Model\classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt(r"C:\Users\hafiz\Anaconda\Final_Year_Project_Implementation\License_Plate_Recognition_Model\flattened_images.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
